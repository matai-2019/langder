...
class Profile extends React.Component {
  render () {
    const { user: { name, languages, description, email }, children, className, SwipeCard } = this.props
    ...
    return (
      <>
        <Card fluid centered className={className} as={SwipeCard} style={{ ...theme.card, ...this.props.style }}>
          <Card.Header
            as="h2"
            content={name}
